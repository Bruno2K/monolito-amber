...
One PostgreSQL instance. Module namespaces: `identity`, `org`, `project`, `document`, `coordination`, `planning`, `governance`, `audit`, `jobs` (later `notification`). Versioned Prisma migrations only.
