...
2. Implement only in-scope changes on the Work Item branch (currently `pf-1.3-documents-revisions-foundation`). Do not use stale PF-1.0 / PF-1.1 / PF-1.2 branch names.
