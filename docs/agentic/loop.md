...
2. Implement only in-scope changes on the Work Item branch (currently `pf-1.5-planning-tasks-milestones`). Do not use stale PF-1.0 / PF-1.1 / PF-1.1R / PF-1.2 / PF-1.3 / PF-1.4 branch names.
